...
More speficly `LUX_Custom` and `LUX_ScreenSpace_General`.

## Features
- Easy setup for custom shaders.
- Automatic compilation using `buildshaders.bat`.
...
3. Run the `buildshaders.bat` script to compile all listed shaders. <br>

4. After compilation, your shader will be available in the `game/shaders/fxc` directory.<br>
...
The **LUX** Codebase is licensed under the **[SOURCE 1 SDK LICENSE](LICENSE)**.
